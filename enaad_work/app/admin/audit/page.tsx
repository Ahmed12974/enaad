      ...
      <Card>
        ...
        <CardContent>
          <form method="get" className="admin-filter-form">
            <Input name="search" defaultValue={query.search} placeholder="العملية أو العنصر أو السبب" />
            <Input name="action" defaultValue={query.action} placeholder="نوع العملية" />
            <Input name="entityType" defaultValue={query.entityType} placeholder="نوع العنصر" />
