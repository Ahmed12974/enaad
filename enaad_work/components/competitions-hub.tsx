  ...
  function begin() {
    ...
    start(async () => {
      try {
        ...
        setMessage(error instanceof Error ? error.message : 'تعذر بدء المنافسة.')
      }
    })
  }
  function submit() {
    ...
    start(async () => {
      try {
        ...
        setMessage(error instanceof Error ? error.message : 'تعذر حفظ النتيجة.')
      }
    })
  }
  return (
    <Card className="competition-card">
      <CardHeader>
        <div className="competition-card-top">
          ...
          <span dir="ltr">{item.xpReward} XP</span>
        </div>
