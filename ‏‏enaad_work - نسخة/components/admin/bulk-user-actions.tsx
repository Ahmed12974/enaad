  ...
  function execute() {
    ...
    startTransition(async () => {
      try {
        ...
        setResult({
          ok: false,
          message: error instanceof Error ? error.message : 'تعذر تنفيذ العملية الجماعية.',
        })
      } finally {
        setQueued(null)
      }
  ...
  return (
    <div className="admin-stack-sm">
      <form ref={ref} onSubmit={submit} className="admin-filter-form">
        ...
        <Input name="reason" required minLength={5} maxLength={1000} placeholder="سبب أو نص الملاحظة" />
