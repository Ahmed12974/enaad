          ...
          <CardContent>
            ...
            >
              <div className="admin-form-grid">
                ...
                <Input name="target" type="number" min="1" required defaultValue={item.target} />
                <Input name="xpReward" type="number" min="0" defaultValue={item.xpReward} />
                <Input name="coinReward" type="number" min="0" defaultValue={item.coinReward} />
                <Input name="competitionType" required defaultValue={item.competitionType} />
                <Input
                  name="startsAt"
                  type="datetime-local"
                ...
                />
                <Input name="winnerCount" type="number" min="1" defaultValue={item.winnerCount} />
              ...
              <Textarea name="description" required minLength={5} defaultValue={item.description} />
          ...
          <Card>
            ...
            <CardContent>
              ...
              >
                ...
                <Input name="reason" minLength={5} placeholder="سبب الإنهاء أو الإلغاء" />
              </ManagedActionForm>
            </CardContent>
          </Card>
          <Card>
            ...
            <CardContent className="admin-stack">
              ...
              >
                <Input name="reason" required minLength={5} placeholder="سبب الاعتماد" />
              </ManagedActionForm>
            </CardContent>
          </Card>
        </div>
        ...
        <Card>
          ...
          <CardContent className="admin-table-wrap">
            ...
            {data.results.length > 0 && (
              ...
              >
                <Input name="reason" required minLength={10} placeholder="سبب تفصيلي لإلغاء الاعتماد" />
              </ManagedActionForm>
            )}
          </CardContent>
        </Card>
