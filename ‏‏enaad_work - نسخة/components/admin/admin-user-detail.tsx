        ...
        <Card>
          ...
          <CardContent className="admin-operation-grid">
            ...
            >
              ...
              <Input name="reason" required minLength={5} placeholder="سبب إلزامي" />
            </ActionForm>
            ...
            <ActionForm action={addUserAdminNote} label="إضافة ملاحظة">
              ...
              <Textarea name="note" required minLength={3} placeholder="الملاحظة" />
            </ActionForm>
            <ActionForm action={recordUserViolation} label="تسجيل مخالفة" confirmText="تأكيد تسجيل المخالفة؟">
              <input type="hidden" name="userId" value={user.id} />
              <Textarea name="reason" required minLength={5} placeholder="وصف المخالفة" />
            </ActionForm>
