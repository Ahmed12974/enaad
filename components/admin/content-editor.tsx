  ...
  function submit(event: FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      try {
        ...
        setResult({ ok: false, message: publicActionError(error, 'تعذر حفظ المحتوى.') })
      }
    })
  }
  return (
        ...
        <CardContent>
          <form className="admin-form" onSubmit={submit}>
            <div className="admin-form-grid">
              ...
              <Input aria-label="العنوان" name="title" required minLength={2} defaultValue={item?.title} placeholder="العنوان" />
            ...
            <Textarea aria-label="الملخص" name="summary" defaultValue={item?.summary ?? ''} placeholder="الملخص" />
            <Textarea aria-label="نص الدرس أو القصة أو المادة التعليمية"
              name="contentText"
              defaultValue={bodyText(body.text)}
              placeholder="نص الدرس أو القصة أو المادة التعليمية"
            />
            <Textarea aria-label="تعليمات المتعلم"
              name="instructions"
              defaultValue={bodyText(body.instructions)}
              placeholder="تعليمات المتعلم"
            />
            <div className="admin-form-grid">
              <Input aria-label="المدة التقديرية بالدقائق"
              ...
              />
              <Input aria-label="الحد الأقصى للمحاولات (0 بلا حد)"
                name="maxAttempts"
                type="number"
                min="0"
