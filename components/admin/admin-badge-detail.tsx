          ...
          <CardContent>
            ...
            >
              <div className="admin-form-grid">
                <Input aria-label="الاسم" name="name" required minLength={2} defaultValue={item.name} />
                <Input aria-label="المعرّف"
                  name="slug"
                  required
                  dir="ltr"
              ...
              <Textarea aria-label="الوصف" name="description" required minLength={3} defaultValue={item.description} />
        ...
        <div className="admin-stack">
          <Card>
            ...
            <CardContent>
              ...
              >
                <Input aria-label="رقم المستخدم" name="userId" required placeholder="رقم المستخدم" />
                <input type="hidden" name="badgeId" value={item.id} />
                {item.isRepeatable && <Input aria-label="مفتاح التكرار" name="repeatKey" required placeholder="مفتاح التكرار" />}
      ...
      <Card>
        ...
        <CardContent className="admin-stack">
          <form method="get" className="admin-filter-form">
            <Input aria-label="اسم المستخدم أو البريد" name="search" placeholder="اسم المستخدم أو البريد" />
