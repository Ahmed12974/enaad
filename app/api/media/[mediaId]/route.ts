    ...
    .where(
      and(
        ...
        or(
          ...
          sql`exists(select 1 from "educationalSections" s where (s."imageMediaId" = ${mediaId}::uuid or s."iconMediaId" = ${mediaId}::uuid) and s.status = 'published' and s."isActive" = true and s."deletedAt" is null)`,
